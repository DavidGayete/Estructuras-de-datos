/**
 * Main function.
 * When the program is executed this function is executed.
 * 
...
/**
 * The main function execute some functions created how insertIntoTree, FindInTree, printTree...
 * First load the dictionary, search a list of words inside it, print the Tree in order and finally clean the tree.
 */
